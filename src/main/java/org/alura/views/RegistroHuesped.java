...
public class RegistroHuesped extends JFrame {
    ...
    public RegistroHuesped(Integer idR) {
        this.id = idR;
        ...
        txtNacionalidad.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                selectedItem[0] = txtNacionalidad.getSelectedItem().toString(); // Obtener el valor seleccionado como una cadena de caracteres
        ...
        txtNreserva.setText(String.valueOf(this.id));
        ...
        final LocalDate[] fechaNacimiento = new LocalDate[1];
        final String fechaNacimientoS[] = {""};
        btnguardar.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try{
                    ...
                    fechaNacimiento[0] = txtFechaN.getDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
                    String nacionalidad = selectedItem[0];
                    String telefono = txtTelefono.getText();
                    fechaNacimientoS[0] = fechaNacimiento[0].format(DateTimeFormatter.ofPattern("dd/MM/yyyy"));
                    Huesped huesped = new Huesped(nombre, apellido, fechaNacimientoS[0], nacionalidad, telefono, new Reserva(id));
